...
class ChessBoard : ChessGame() {
    ...
    val leftWhiteRook  = Rook("h1", "white")
    val rightWhiteRook = Rook("a1", "white")
    val leftBlackRook  = Rook("h8", "black")
    val rightBlackRook = Rook("a8", "black")

    val leftWhiteKnight  = Knight("g1", "white")
    val rightWhiteKnight = Knight("b1", "white")
    val leftBlackKnight  = Knight("g8", "black")
    val rightBlackKnight = Knight("b8", "black")

    val leftWhiteBishop  = Bishop("f1", "white") 
    val rightWhiteBishop = Bishop("c1", "white")
    val leftBlackBishop  = Bishop("f8", "black")
    val rightBlackBishop = Bishop("c8", "black")
    ...
    val whitePawn1 = Pawn("h2", "white")
    val whitePawn2 = Pawn("g2", "white")
    val whitePawn3 = Pawn("f2", "white")
    val whitePawn4 = Pawn("e2", "white")
    val whitePawn5 = Pawn("d2", "white")
    val whitePawn6 = Pawn("c2", "white")
    val whitePawn7 = Pawn("b2", "white")
    val whitePawn8 = Pawn("a2", "white")

    val blackPawn1 = Pawn("h7", "black")
    val blackPawn2 = Pawn("g7", "black")
    val blackPawn3 = Pawn("f7", "black")
    val blackPawn4 = Pawn("e7", "black")
    val blackPawn5 = Pawn("d7", "black")
    val blackPawn6 = Pawn("c7", "black")
    val blackPawn7 = Pawn("b7", "black")
    val blackPawn8 = Pawn("a7", "black")
